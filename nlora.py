...
def train():
    ...
    if script_args.local_rank <= 0:  
        ...
        wandb.init(
            ...
            group = f"{script_args.model_name_or_path.split('/')[-1]}_{script_args.init_lora_weights}_{time.strftime('%m%d')}_lr{script_args.learning_rate}_r{script_args.lora_rank}",
            name=run_name,    
            mode="online"
        )
