...
class LoraConfig(PeftConfig):
    ...
    # todo: add
    init_lora_weights: bool | Literal["gaussian", "olora", "pissa", "pissa_niter_[number of iters]", "loftq", "n_lora", "s_lora"] = field(
        default=True,
        metadata={
            "help": (
...
# todo: 改
class NLoraConfig(LoraConfig):

    def __post_init__(self):
        super().__post_init__()
        self.peft_type = PeftType.NLORA  #有用吗
        self.init_lora_weights = "n_lora"
    pass
